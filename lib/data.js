...
//function must push not to the json file 
//tools to search for stringify and writefile functions from npm 

//a function to locate a specific note by id 
//function will locate from notearray 
...
module.exports = {//all functions go here};